...
void main()
{
	...
	occlusion  = texture(occlusionImage, verticalUVs[0]).rgb * FIRST_WEIGHT;
	occlusion += texture(occlusionImage, verticalUVs[1]).rgb * CENTER_WEIGHT;
	occlusion += texture(occlusionImage, verticalUVs[2]).rgb * FIRST_WEIGHT;
#elif BLUR_5x5
	...
	occlusion  = texture(occlusionImage, verticalUVs[0]).rgb * FIRST_WEIGHT;
	occlusion += texture(occlusionImage, verticalUVs[1]).rgb * SECOND_WEIGHT;
	occlusion += texture(occlusionImage, verticalUVs[2]).rgb * CENTER_WEIGHT;
	occlusion += texture(occlusionImage, verticalUVs[3]).rgb * SECOND_WEIGHT;
	occlusion += texture(occlusionImage, verticalUVs[4]).rgb * FIRST_WEIGHT;
#elif BLUR_7x7
	vec2 verticalOffsetSmall  = vec2(1.0f, 0.0f);
	vec2 verticalOffsetMedium = vec2(2.0f, 0.0f);
	...
	occlusion  = texture(occlusionImage, verticalUVs[0]).rgb * FIRST_WEIGHT;
	occlusion += texture(occlusionImage, verticalUVs[1]).rgb * SECOND_WEIGHT;
	occlusion += texture(occlusionImage, verticalUVs[2]).rgb * THIRD_WEIGHT;
	occlusion += texture(occlusionImage, verticalUVs[3]).rgb * CENTER_WEIGHT;
	occlusion += texture(occlusionImage, verticalUVs[4]).rgb * THIRD_WEIGHT;
	occlusion += texture(occlusionImage, verticalUVs[5]).rgb * SECOND_WEIGHT;
	occlusion += texture(occlusionImage, verticalUVs[6]).rgb * FIRST_WEIGHT;
#endif

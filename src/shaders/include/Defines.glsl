...
// Set 0
#define RT0_DESCRIPTOR_SET_0_NUM_BINDINGS 8
#define RT0_ACCELERATION_STRUCTURE_NV_BINDING_LOCATION 0
#define RT0_COLOR_IMAGE_BINDING_LOCATION 1
#define RT0_MOTION_VECTOR_IMAGE_BINDING_LOCATION 2
#define RT0_POSITION_IMAGE_BINDING_LOCATION 3
#define RT0_NORMAL_IMAGE_BINDING_LOCATION 4
#define RT0_CAMERA_BUFFER_BINDING_LOCATION 5
#define RT0_LIGHTS_BUFFER_BINDING_LOCATION 6
#define RT0_OTHER_DATA_BUFFER_BINDING_LOCATION 7
